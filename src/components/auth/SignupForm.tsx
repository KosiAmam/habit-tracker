...
function BrandPanel() {
  return (
    ...
    >
      ...
      {/* Bottom — copy, different from login */}
...
export default function SignupForm() {
  ...
  function handleSubmit(e: React.FormEvent) {
    ...
    const result = signUp(ev.value, password);
    if (!result.ok) {
    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="flex flex-col items-center mb-8 lg:hidden">
          <div
            className="w-12 h-12 rounded-full bg-orange-primary flex items-center
                          justify-center mb-2"
          >
            ...
            {serverErr && (
              <div
                className="flex items-center gap-2 bg-red-50 border border-red-200
                              text-red-600 text-sm px-4 py-3 rounded-input"
                role="alert"
              >
                  ...
                  {[
                    ...
                    <li
                      ...
                      className={`text-xs flex items-center gap-1.5
                                    ${ok ? 'text-green-600' : 'text-text-secondary'}`}
                    >
                      <span
